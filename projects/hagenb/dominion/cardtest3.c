...
int main() 
{
	...
	printf("\tThe card at the last handPos (8) should be discarded, ie, == -1\n");
	printf("\tCard at handPos %d = %d, expected = %d\t", handPos, testG.hand[thisPlayer][8], -1);
	pass(testG.hand[thisPlayer][8], -1);
